...
function Calendar2Check(props) {
    return (<Svg width={16} height={16} fill="currentColor" {...props}>
      <Path d="M10.854 8.146a.5.5 0 010 .708l-3 3a.5.5 0 01-.708 0l-1.5-1.5a.5.5 0 01.708-.708L7.5 10.793l2.646-2.647a.5.5 0 01.708 0z"/>
