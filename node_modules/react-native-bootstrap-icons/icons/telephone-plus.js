...
function TelephonePlus(props) {
    return (<Svg width={16} height={16} fill="currentColor" {...props}>
      ...
      <Path fillRule="evenodd" d="M12.5 1a.5.5 0 01.5.5V3h1.5a.5.5 0 010 1H13v1.5a.5.5 0 01-1 0V4h-1.5a.5.5 0 010-1H12V1.5a.5.5 0 01.5-.5z"/>
    </Svg>);
}
